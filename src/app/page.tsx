      ...
      <div className="py-24 bg-slate-50 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <CategoryCard title="App Development" icon={<Smartphone className="w-6 h-6" />} count="15 Courses" />
            <CategoryCard title="Flutter" icon={<Code2 className="w-6 h-6" />} count="10 Courses" />
            <CategoryCard title="Wordpress" icon={<Globe className="w-6 h-6" />} count="8 Courses" />
            <CategoryCard title="AI Bot Development" icon={<Bot className="w-6 h-6" />} count="6 Courses" />
            <CategoryCard title="AI Development" icon={<Brain className="w-6 h-6" />} count="12 Courses" />
            <CategoryCard title="Python" icon={<Terminal className="w-6 h-6" />} count="20 Courses" />
            <CategoryCard title="Machine Learning" icon={<Network className="w-6 h-6" />} count="14 Courses" />
          </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">Contact for Enrollment</h3>
              <p className="text-slate-300 mb-8 max-w-md mx-auto">
                Ready to join? Contact us directly if you have any questions about enrollment or courses.
              </p>

              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/10 inline-block w-full max-w-md">
                <p className="text-sm font-medium text-slate-300 mb-1 uppercase tracking-wider">Contact Number</p>
                <div className="text-3xl md:text-4xl font-mono font-bold text-yellow-500 tracking-wider mb-2">
                  +923046983794
                </div>
